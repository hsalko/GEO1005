...
class WalkAble:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&WalkAble')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'WalkAble')
        self.toolbar.setObjectName(u'WalkAble')

        #print "** INITIALIZING WalkAble"
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('WalkAble', message)
